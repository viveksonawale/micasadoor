          ...
          <div className={styles.splitContainer}>
            ...
            <div className={styles.infoColumn}>
              <h2 className={styles.infoTitle}>
                Get In Touch With <span className={styles.infoTitleHighlight}>Us</span>
              </h2>
              <p className={styles.infoDescription}>
                We&apos;d love to help you find the perfect door solution. Reach us via any of the channels below and our team will get back to you promptly.
              </p>
